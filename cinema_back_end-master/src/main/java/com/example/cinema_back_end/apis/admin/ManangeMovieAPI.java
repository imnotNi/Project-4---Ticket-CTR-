...
public class ManangeMovieAPI {
    ...
    public ResponseEntity<String> addMovie(@RequestBody MovieDTO movie){
        ...
        return  new ResponseEntity<String>("Added movie successfully!" ,HttpStatus.OK);
    }
    @PutMapping
    public ResponseEntity<String> updateMovie(@RequestBody MovieDTO movie){
    	movieService.update(movie);
        return  new ResponseEntity<String>("Updated movie successfully!" ,HttpStatus.OK);
    }
    @DeleteMapping
    public ResponseEntity<String> deleteMovie(@Param("movieId") Integer movieId){
    	movieService.remove(movieId);
    	return new ResponseEntity<String>("Deleted movie successfully!", HttpStatus.OK);
    }
}
